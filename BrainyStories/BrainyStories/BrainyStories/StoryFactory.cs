        ...
        public Story playedStory(String storyName)
        {
            ...
            else if (storyName.Equals("The Little Red Hen"))
            {
                chosen = new Story
                {
                    ...
                    { new TimeSpan(0, 0, 3), "S2_LRH_2.jpg" },
                    { new TimeSpan(0, 0, 25), "S2_LRH_3.jpg" },
                    { new TimeSpan(0, 0, 55), "S2_LRH_4.jpg" },
                    { new TimeSpan(0, 1, 05), "S2_LRH_5.jpg" },
                    { new TimeSpan(0, 1, 36), "S2_LRH_6.jpg" },
                    { new TimeSpan(0, 2, 8), "S2_LRH_7.jpg" },
                    { new TimeSpan(0, 2, 40), "S2_LRH_8.jpg" }
                },
            ...
            else if (storyName.Equals("The Boy Who Cried Wolf"))
            {
                chosen = new Story
                {
                    ...
                    { new TimeSpan(0, 3, 6), "S3_TBWCW_7.jpg" },
            ...
            else if (storyName.Equals("The Three Little Pigs"))
            {
                chosen = new Story
                {
                    ...
                    { new TimeSpan(0, 0, 4), "S5_TLP_2.jpg" },
                    { new TimeSpan(0, 0, 27), "S5_TLP_3.jpg" },
                    { new TimeSpan(0, 1, 10), "S5_TLP_4.jpg" },
                    { new TimeSpan(0, 1, 44), "S5_TLP_5.jpg" },
                    { new TimeSpan(0, 2, 21), "S5_TLP_6.jpg" },
                    { new TimeSpan(0, 2, 43), "S5_TLP_7.jpg" },
                    { new TimeSpan(0, 3, 14), "S5_TLP_8.jpg" },
                    { new TimeSpan(0, 3, 30), "S5_TLP_9.jpg" },
                    { new TimeSpan(0, 3, 59), "S5_TLP_10.jpg" },
                    { new TimeSpan(0, 4, 21), "S5_TLP_11.jpg" },
                    { new TimeSpan(0, 4, 50), "S5_TLP_12.jpg" },
                    { new TimeSpan(0, 5, 58), "S5_TLP_13.jpg" },
                    { new TimeSpan(0, 6, 12), "S5_TLP_14.jpg" }
                },
            ...
            else if (storyName.Equals("The Three Billy Goats Gruff"))
            {
                chosen = new Story
                {
                    ...
                    { new TimeSpan(0, 1, 58), "S6_BGG_7.jpg" },
            ...
            else if (storyName.Equals("The Tale of Peter Rabbit"))
            {
                chosen = new Story
                {
                    ...
                    { new TimeSpan(0, 0, 5), "S7_PR_2.jpg" },
                    { new TimeSpan(0, 0, 23), "S7_PR_3.jpg" },
                    { new TimeSpan(0, 0, 48), "S7_PR_4.jpg" },
                    { new TimeSpan(0, 1, 01), "S7_PR_5.jpg" },
                    { new TimeSpan(0, 1, 09), "S7_PR_6.jpg" },
                    { new TimeSpan(0, 1, 20), "S7_PR_7.jpg" },
                    { new TimeSpan(0, 1, 30), "S7_PR_8.jpg" },
                    { new TimeSpan(0, 1, 36), "S7_PR_9.jpg" },
                    { new TimeSpan(0, 1, 45), "S7_PR_10.jpg" },
                    { new TimeSpan(0, 1, 58), "S7_PR_11.jpg" },
                    { new TimeSpan(0, 2, 09), "S7_PR_12.jpg" },
                    { new TimeSpan(0, 2, 29), "S7_PR_13.jpg" },
                    { new TimeSpan(0, 2, 43), "S7_PR_14.jpg" },
                    { new TimeSpan(0, 2, 52), "S7_PR_15.jpg" },
                    { new TimeSpan(0, 3, 05), "S7_PR_16.jpg" },
                    { new TimeSpan(0, 3, 20), "S7_PR_17.jpg" },
                    { new TimeSpan(0, 3, 33), "S7_PR_18.jpg" },
                    { new TimeSpan(0, 3, 47), "S7_PR_19.jpg" },
                    { new TimeSpan(0, 4, 30), "S7_PR_20.jpg" },
                    { new TimeSpan(0, 5, 17), "S7_PR_21.jpg" },
                    { new TimeSpan(0, 5, 55), "S7_PR_22.jpg" },
                    { new TimeSpan(0, 6, 14), "S7_PR_23.jpg" },
                    { new TimeSpan(0, 6, 23), "S7_PR_24.jpg" },
                    { new TimeSpan(0, 6, 55), "S7_PR_25.jpg" },
                    { new TimeSpan(0, 7, 14), "S7_PR_26.jpg" }
                },
            ...
            else if (storyName.Equals("The Gingerbread Man"))
            {
                chosen = new Story
                {
                    ...
                    { new TimeSpan(0, 1, 5), "S8_TGM_3.jpg" },
                    { new TimeSpan(0, 1, 47), "S8_TGM_4.jpg" },
                    { new TimeSpan(0, 2, 25), "S8_TGM_5.jpg" },
                    { new TimeSpan(0, 3, 26), "S8_TGM_6.jpg" },
                    { new TimeSpan(0, 4, 15), "S8_TGM_7.jpg" },
                    { new TimeSpan(0, 4, 53), "S8_TGM_8.jpg" },
                    { new TimeSpan(0, 5, 29), "S8_TGM_9.jpg" },
                    { new TimeSpan(0, 6, 26), "S8_TGM_10.jpg" },
                    { new TimeSpan(0, 7, 24), "S8_TGM_11.jpg" }
                },
            ...
            else if (storyName.Equals("Do You Like Bubbles"))
            {
                chosen = new Story
                {
                    ...
                    { new TimeSpan(0, 2, 0), "I10_DYLB_8.jpg" },
